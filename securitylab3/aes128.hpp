...
public:
    aes128();
    std::string enc(std::string user_in, uint8_t* key);
    std::string dec(std::string user_in, uint8_t* key);

private:
    //functions
    std::string encrypt_syb(std::string user_in,uint8_t* key);
    std::string decrypt_syb(std::string user_in, uint8_t* key);

    uint32_t sub_int(uint32_t);
    uint32_t subword(uint32_t x);
    uint8_t** subBytes(uint8_t**, uint8_t);
    uint32_t rotword(uint32_t);

    uint32_t* keyExpansion(uint8_t* key, uint32_t* w, uint8_t Nb, uint8_t Nk, uint8_t Nr);
    uint8_t* cipher(uint8_t* input, uint8_t* output, uint32_t* w, uint8_t Nb, uint8_t Nr);
    uint8_t* invCipher(uint8_t* input, uint8_t* output, uint32_t* w, uint8_t Nb, uint8_t Nr);
